...
The easiest way to swap out the Odyssey logo across the site is to replace this code with the SVG code for your council's logo or using an `<img>` tag linked to your council logo.
